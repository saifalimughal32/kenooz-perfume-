  ...
  <section data-bottle="left" className="surface-light py-20">
    <div className="container-luxury grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="reveal-right grid grid-cols-2 gap-3">
        <img src={factory1} loading="lazy" width={1200} height={800} alt="Manufacturing facility" className="col-span-2 h-56 w-full object-cover" />
        <img src={factory2} loading="lazy" width={1200} height={800} alt="Perfumers in lab" className="h-44 w-full object-cover" />
        <img src={factory3} loading="lazy" width={1200} height={800} alt="Bottling line" className="h-44 w-full object-cover" />
      </div>
    </div>
  </section>
);
