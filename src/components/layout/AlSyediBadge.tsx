...
const AlSyediBadge = () => {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-40 group flex items-center justify-center h-20 w-20 rounded-full bg-background/90 backdrop-blur border border-primary/30 shadow-[0_10px_30px_-10px_hsl(var(--primary)/0.5)] hover:scale-110 hover:border-primary transition-all duration-300"
    >
      <img
        src={alSyediLogo}
        alt="Al-Syedi"
